...
const summary = {
  ...
  // Updated independently from the official monthly study; never reset to a curated snapshot.
  issues: JSON.parse(await readFile(resolve("public/spain-summary.json"), "utf8")).issues,
};
