...
const INCLUDE_IPSOS = false; // Requires documented permission and code review.
...
const PERSONAL_ISSUES = null; // Withheld pending permission.

const PERSONAL_ECONOMY = null; // Withheld pending permission.

const COUNTRY_ECONOMY_FALLBACK = null; // Withheld pending permission.
